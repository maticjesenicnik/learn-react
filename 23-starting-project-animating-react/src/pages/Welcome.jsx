...
export default function WelcomePage() {
  ...
  const opacityCity = useTransform(scrollY, [0, 200, 400, 700], [1, 0.5, 0.5, 0]);
    ...
    <>
      ...
      <main id="welcome-content">
        <section>
          ...
          <p>
            With our platform, you can set, track, and conquer challenges at your own pace. Whether it&apos;s personal growth, professional achievements, or just for fun,
        ...
        <section>
          ...
          <p>
            Challenges provide a framework for growth. They push boundaries, test limits, and result in genuine progress. Here, we believe everyone has untapped potential, waiting
            to be unlocked.
          </p>
        </section>
